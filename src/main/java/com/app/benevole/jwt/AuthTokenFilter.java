...
public class AuthTokenFilter extends OncePerRequestFilter {
    ...
    @Value(value = "${application.security.header}")
    private String HEADER;
    @Value(value = "${application.security.prefix}")
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        try {
            ...
            if (jwt != null && jwtUtils.validateJwtToken(jwt)) {
                ...
                UserDetails userDetails = userDetailsService.loadUserByUserId(subject);
    ...
    private String parseJwt(HttpServletRequest request) {
        ...
        if (StringUtils.hasText(headerAuth) && headerAuth.startsWith(String.format("%s ", PREFIX))) {
